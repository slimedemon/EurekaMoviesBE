...
namespace EurekaMovieBE.Features.Queries.MovieQueries.GetTrendingThisWeek;

public class GetTrendingMovieThisWeekValidator : AbstractValidator<GetTrendingMovieThisWeekQuery>
{
    public GetTrendingMovieThisWeekValidator()
    {
