using EurekaMovieBE.Features.Commands.WatchListCommands.AddMovieToWatchList;
using EurekaMovieBE.Features.Commands.WatchListCommands.RemoveMovieFromWatchList;
using EurekaMovieBE.Features.Queries.WatchListQueries.GetWatchList;
