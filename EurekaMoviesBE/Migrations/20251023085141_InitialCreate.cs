    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorite", x => x.Index);
                    table.ForeignKey(
                        name: "FK_Favorite_UserInfo_UserId",
                        column: x => x.UserId,
                        principalSchema: "movieschema",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rating", x => x.Index);
                    table.ForeignKey(
                        name: "FK_Rating_UserInfo_UserId",
                        column: x => x.UserId,
                        principalSchema: "movieschema",
                        principalTable: "UserInfo",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchList", x => x.Index);
                    table.ForeignKey(
                        name: "FK_WatchList_UserInfo_UserId",
                        column: x => x.UserId,
                        principalSchema: "movieschema",
                        principalTable: "UserInfo",
                        principalColumn: "Id",
