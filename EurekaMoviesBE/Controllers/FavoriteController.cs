using EurekaMoviesBE.Features.Commands.FavoriteCommands.MarkAsFavorite;
using EurekaMoviesBE.Features.Commands.FavoriteCommands.UnmarkFavorite;
using EurekaMoviesBE.Features.Queries.FavoriteQueries.GetListFavorite;
using MediatR;
